  ...
  @ApiProperty({
    ...
    example: {
      user: {
        ...
        about:
          "I love learning new technologies and discussing programming concepts",
      ...
      friends: [
        {
          ...
          about:
            "Specialized in explaining complex technical concepts in simple terms",
          knowledge_base:
            "Programming languages, system design, best practices",
        },
        {
          name: "CreativeAI",
          persona: "An artistic and imaginative companion",
          about:
            "Loves brainstorming creative solutions and thinking outside the box",
